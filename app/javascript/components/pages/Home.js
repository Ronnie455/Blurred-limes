  ...
  return (
    <>
      ...
      <UncontrolledCarousel
        ...
        {
          altText: 'Slide 1',
          caption: 'Tracking what I eat can be a powerful tool for becoming more aware of my dietary habits and making positive changes. By using Blurred Limes I can easily record what I eat, monitor my calorie intake, and track my nutrient intake, which can help me make more informed decisions about my diet. - Manny Flores',
          key: 1,
        ...
        {
          altText: 'Slide 2',
          caption: 'Blurred Limes helped me achieve my weight loss or fitness goals by keeping me accountable and motivated. Seeing my progress over time, such as reaching daily calorie or nutrient goals, can be incredibly rewarding and inspiring. -Jake Palmer',
          key: 2,
        ...
        {
          altText: 'Slide 5',
          caption: 'By logging your food and grocery purchases, you can ensure that everyone is aware of what is available and who purchased it. This can help prevent situations where one roommate feels like they are constantly buying all the groceries or using up all the shared food. - Jane Smith',
          key: 5,
