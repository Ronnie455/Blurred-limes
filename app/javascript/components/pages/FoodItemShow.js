      ...
      <div className="show-item">
        {selectedFoodItem && (
          <Card style={{ width: "50%", height: "600px" }}>
            <CardBody>
              <CardTitle tag="h5">{selectedFoodItem.name}</CardTitle>
            ...
            />
            <CardBody>
              <CardText>Quantity: {selectedFoodItem.quantity}</CardText>
              <CardText>
              ...
              {logged_in && (
                <>
                  <Button>
                    <NavLink style={{ color: "white" }} to={`/fooditemedit/${selectedFoodItem?.id}`}>
                      Edit Food Item
                    </NavLink>
                  </Button>
